...
aai.settings.api_key = "444c21ad4ecb4e4696d5d1bbfb7af056"
import os
...
class VoiceEmotionAnalyzer:
    ...
    def analyze_emotion(self, audio_path):
        ...
        try:
            ...
            elif hasattr(transcript, 'iab_categories') and transcript.iab_categories:
                # Fallback: use transcription confidence as neutral sentiment
                sentiments = None
            ...
            if sentiments and len(sentiments) > 0:
                ...
                # If no sentiment data, analyze based on transcript text using simple rules
